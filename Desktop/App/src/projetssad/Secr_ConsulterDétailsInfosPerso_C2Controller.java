 ...
 * @author user
 */
public class Secr_ConsulterDétailsInfosPerso_C2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            ResultSet myRs = myStmt.executeQuery("SELECT `nom`, `prenom`,`tel1`, `email`, `dateN`, `grpsanguin`,`genre`,h.nomHopital, s.nomService, `idMedecin` FROM `patient`, service s, hopital h WHERE `idPatient` = "+Secret_ConsulterInfosPersoPatient_cas2Controller.idP+" AND h.idHopital = "+AuthentificationController.idH_Secretaire+" AND s.idService = "+AuthentificationController.idS_Secretaire+"");
            ...
            while(myRs.next()){
                ...
                telP.setText(myRs.getString("tel1"));
                emailP.setText(myRs.getString("email"));
                nomM.setText(nomMed);
            ...
            Logger.getLogger(Secr_ConsulterDétailsInfosPerso_C2Controller.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
     @FXML

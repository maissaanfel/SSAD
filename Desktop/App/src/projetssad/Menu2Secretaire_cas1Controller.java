 ...
 * @author user
 */
public class Menu2Secretaire_cas1Controller implements Initializable {

    public void AjouterInfosPersoPatient(ActionEvent event) throws SQLException, IOException
    {
        Main.stage.close(); 
        Parent parent = FXMLLoader.load(getClass().getResource("AjouterInfosPersoPatient_cas1.fxml"));
    ...
    {
        Main.stage.close(); 
        Parent parent = FXMLLoader.load(getClass().getResource("Secret_ConsulterInfosPersoPatient_cas1.fxml"));
        Scene scene = new Scene(parent);
        Stage stage = new Stage();
        stage.setScene(scene);
        stage.show();

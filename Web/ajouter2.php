<?php 
    ...
    $dep = $bdd->prepare("INSERT INTO patient (`nom`,`prenom`,`email`,`tel1`,`tel2`,`dateN`,`grp-sanguin`,`genre`,`idHopital`,`idService`,`idMedecin`,`archive`) VALUES ('$nom','$prenom','$email','$tel1','','$date','$gs','Homme','$idh','$id','$idmed','non') ;");
    $res=$dep->execute();

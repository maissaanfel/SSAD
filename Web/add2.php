<?php 
    ...
    $mal = ($_POST['mal']);
    $mald = openssl_encrypt($mal,$ciphering,$encryption_key,$option,$encryption_iv);
    $obs = ($_POST['obs']);
    ...
    $dep = $bdd->prepare("INSERT INTO consultation (`taille`,`poids`,`tension`,`antecedents`,`maladiesChroniques`,`observation`,`diagnostic`,`analyse`,`examenMedical`,`resultat`,`commentaire`,`dateConsult`,`idPatient`) VALUES ('$taillec','$poidsc','$tensc','','$mald','$obsc','$diagc','$anac','$examc','$resc','$comc','$date','$idp') ;");
    $res=$dep->execute();
